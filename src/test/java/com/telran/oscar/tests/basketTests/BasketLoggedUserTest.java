...
public class BasketLoggedUserTest extends TestBase {
    ...
    public void addOneBookToBasketTest() {
        String name = new BrowseStoreMenuPage(driver).clickOnBooksItem().clickOnNBookInList(1)
    ...
    public void addOneClothingToBasketTest() {
        ...
        String price = new ClothingPage(driver).addClothingToBasket().getClothingPrice();
        Assert.assertTrue(new HeaderPage(driver).getBasketSum().contains(price));
        BasketPage basket = new HeaderPage(driver).clickViewBasket();
    ...
    public void multipleOneBookInBasketPositiveTest() {
        ...
        String price = new BrowseStoreMenuPage(driver).clickOnBooksItem().clickOnNBookInList(1)
    ...
    public void emptyBasketPositiveTest() {
        new BrowseStoreMenuPage(driver).clickOnBooksItem().clickOnNBookInList(1).addBookToBasket();
        new NavigateMenuPage(driver).returnToHomePage().clickOnClothingItem().clickOnFirstClothingInList()
                .addClothingToBasket();
